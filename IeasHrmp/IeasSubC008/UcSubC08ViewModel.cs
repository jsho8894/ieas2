...
{
    public class UcSubC08ViewModel : Notifier, IDataErrorInfo
    {
        ...
        public List<string> Cont_mm_set
        {
            get
            {
                return new List<string>() { "","01","08","03","04","05","06","07","08","09","10","11","12" };
            }
        }
        ...
        private string bas_addr;//나머지 주소
        public string Bas_addr
        {
            get { return bas_addr; }
            set
            {
                if (value == bas_addr) return;

                bas_addr = value;
                OnValueChanged("Bas_addr");
            }
        }
        ...
        public int Bas_ind_wys
{
        ...
        private string bas_remp_mm;//재임용대상 년월
        public string Bas_remp_mm
        {
            get { return bas_remp_mm; }
            set
            {
                if (value == Bas_remp_mm) return;

                bas_remp_mm = value;
                OnValueChanged("Bas_remp_mm");
            }
        }
        ...
        private string bas_nemp_date;//차기임용 예정일
        public string Bas_nemp_date
        {
            get { return bas_nemp_date; }
            set
            {
                if (value == bas_nemp_date) return;

                bas_nemp_date = value;
                OnValueChanged("Bas_nemp_date");
            }
        }
